<!-- Navbar -->
<header class="flex items-center justify-between px-6 py-4 bg-green-400 border-b-2 border-indigo-600">
    ...
    <div class="flex items-center">
        <div x-data="{ notificationOpen: false }" class="relative">
            <button @click="notificationOpen = ! notificationOpen" class="flex mx-4 text-white focus:outline-none">
                <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div x-data="{ dropdownOpen: false }" class="relative">
            ...
            <div x-show="dropdownOpen" class="absolute right-0 z-10 w-48 mt-2 overflow-hidden bg-white rounded-md shadow-xl font-inter" style="display: none;">

...
@section('title', 'SIMAMPU - Jenis Varietas')
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container px-6 py-8 mx-auto">
                    <h3 class="text-3xl font-semibold text-gray-700 font-inter">Jenis Varietas</h3>
                        ...
                        <div class="w-full px-6 font-inter">
                            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                                <button onclick="document.getElementById('modalTambah').showModal()" id="btn" class="w-full md:w-auto text-sm bg-green-500 px-4 py-2 text-white rounded-3xl font-semibold hover:bg-green-800">
                                    ...
                                    Tambah Data Jenis Varietas
                                </button>
                            </div>
                        </div>

                        <!-- Tambah Data Varietas -->
                        @include('pages.varietas.create_varietas')
                        ...
                        <div class="overflow-x-auto rounded-lg">
                            <table class="min-w-full">
                                ...
                                <tbody>
                                    ...
                                    <!-- Ubah Data Varietas -->
                                    @include('pages.varietas.edit_varietas')

                                    <!-- Hapus Data Varietas -->
                                    @include('pages.varietas.delete_varietas')

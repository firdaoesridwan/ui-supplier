        ...
        <div class="bg-white rounded-lg shadow relative">
            <div class="">
                ...
                <div class="p-3 text-center space-x-4 md:block">
                    <button data-modal-toggle="authentication-modal" class="mb-2 md:mb-0 bg-white border-gray-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-black rounded-full hover:shadow-lg hover:bg-gray-500 hover:text-white">
                        Batal
                    </button>

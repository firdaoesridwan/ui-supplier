...
@section('title', 'SIMAMPU - Transaksi')
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container px-6 py-8 mx-auto">
                    <h3 class="text-3xl font-semibold text-gray-700 font-inter">Transaksi</h3>
                    ...
                    <div class="flex flex-wrap -mx-6">
                        ...
                        <!-- Tambah Data Transaksi -->
                        @include('pages.transaksi.create_transaksi')
                        ...
                        <div class="overflow-x-auto rounded-lg">
                            <table class="min-w-full">
                                ...
                                <tbody>
                                    ...
                                    <!-- Ubah Data Transaksi -->
                                    @include('pages.transaksi.edit_transaksi')

                                    <!-- Hapus Data Transaksi -->
                                    @include('pages.transaksi.delete_transaksi')

...
@section('title', 'SIMAMPU - Angkutan')
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container px-6 py-8 mx-auto">
                    <h3 class="text-3xl font-semibold text-gray-700 font-inter">Angkutan</h3>
                    ...
                    <div class="flex flex-wrap -mx-6">
                        ...
                        <!-- Tambah Data Angkutan -->
                        @include('pages.angkutan.create_angkutan')
                        ...
                        <div class="overflow-x-auto rounded-lg">
                            <table class="min-w-full">
                                ...
                                <thead class="bg-green-200">
                                    <tr class="text-left">
                                        <th class="p-3">No.</th>
                                        <th class="p-3">Nama Pemilik Kendaraan</th>
                                        <th class="p-3">Merk Kendaraan</th>
                                        <th class="p-3">Plat Kendaraan</th>
                                        <th class="p-3">Tahun Kendaraan</th>
                                ...
                                <tbody>
                                    ...
                                    <!-- Ubah Data Angkutan -->
                                    @include('pages.angkutan.edit_angkutan')

                                    <!-- Hapus Data Angkutan -->
                                    @include('pages.angkutan.delete_angkutan')

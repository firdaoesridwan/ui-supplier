<dialog id="modalUbah" class="h-auto w-11/12 md:w-1/2 p-5  bg-white rounded-md font-inter">
    <div class="flex flex-col w-full h-auto ">
        ...
        <form>
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <div>
                    <label class="text-black" for="username">Nomor Transaksi</label>
                ...
                <div>
                    <label class="text-black" for="username">Tanggal Transaksi</label>
                    <input id="username" type="text" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-gray-400 rounded-md focus:border-blue-500 focus:outline-none focus:ring">
                </div>
                ...
                <div>
                    <label class="text-black" for="emailAddress">Tahun Tanam</label>
                ...
                <div>
                    <label class="text-black" for="emailAddress">Biaya Angkut</label>
                    <input id="emailAddress" type="email" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-gray-400 rounded-md focus:border-blue-500 focus:outline-none focus:ring">
                </div>
                ...
                <div>
                    <label class="text-black" for="emailAddress">Biaya Total</label>
                    <input id="emailAddress" type="email" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-gray-400 rounded-md focus:border-blue-500 focus:outline-none focus:ring">
                </div>
            </div>

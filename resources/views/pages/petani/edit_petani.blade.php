    ...
    <div class="flex flex-col w-full h-auto ">
        ...
        <form>
            ...
            <div class="flex mt-6 justify-end">
                <div class="">
                    <button onclick="document.getElementById('myModal').close();" class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-red-500 rounded-md hover:bg-red-800 focus:outline-none focus:bg-gray-600">Batal</button>
                </div>

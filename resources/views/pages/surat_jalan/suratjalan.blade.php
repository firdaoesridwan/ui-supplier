...
@section('title', 'SIMAMPU - Surat Jalan')
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container px-6 py-8 mx-auto">
                    <h3 class="text-3xl font-semibold text-gray-700 font-inter">Surat Jalan</h3>
                    ...
                    <div class="flex flex-wrap -mx-6">
                        ...
                        <!-- Tambah Data Surat Jalan -->
                        @include('pages.surat_jalan.create_suratjalan')
                        ...
                        <div class="overflow-x-auto rounded-lg">
                            <table class="min-w-full">
                                ...
                                <tbody>
                                    ...
                                    @include('pages.surat_jalan.edit_suratjalan')

                                    <!-- Hapus Data Surat Jalan -->
                                    @include('pages.surat_jalan.delete_suratjalan')
